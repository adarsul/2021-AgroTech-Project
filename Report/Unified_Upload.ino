...
const int INTERVAL_DUR = ; //15 seconds increments of watering for interval watering
const int MOISTURE_DUR = ; //15 seconds increments of watering for soil sensor
const int SCALE_DUR = ;    //15 seconds increments of watering for scale
...
float MAX_WEIGHT =; //max weight with water
float MIN_WEIGHT =; //min weight threshold
